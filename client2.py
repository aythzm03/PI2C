...
def subscribe_to_server():
    ...
    subscribe_message = {
        "request": "subscribe",
        "port": 1111,  # Port d'écoute de ton client (il doit être en écoute dessus)
        "name": "AyatChampion",  # Nom de ton IA
        "matricules": ["22081", "2229"]  # Tes matricules
    }
...
def listen_for_requests():
    ...
    host = "0.0.0.0"
    port = 1111  # Doit être le même que dans subscribe
